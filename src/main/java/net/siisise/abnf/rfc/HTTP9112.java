...
public class HTTP9112 {
    ...
    // 3. Request Line
    static final ABNF requestLine = REG.rule("request-line", method.pl(SP,requestTarget,SP,HTTPversion));
    // 2.1. Message Format
    static final ABNF startLine = REG.rule("start-line", requestLine.or1(statusLine));
